...
function initial(){
	...
	}else if(based_modelid == "RT-AC95U" || based_modelid == "RT-AX95Q" || based_modelid == "XT8PRO" || based_modelid == "XT8_V2" || based_modelid == "RT-AXE95Q" || based_modelid == "ET8PRO" || based_modelid == "RT-AX82_XD6" || based_modelid == "RT-AX82_XD6S" || based_modelid == "RT-AC3100"){
		document.form.wans_lanport1.remove(3);
		document.form.wans_lanport2.remove(3);
	}
